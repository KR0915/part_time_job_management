<br />
<h2>ログイン</h2>
<?php echo $this->Form->create('Manager', array('url' => array('controller' => 'managers', 'action' => 'login'), 'class' => 'login-form')); ?>
    <fieldset>
        <?php
...
<?php echo $this->Form->end(array('label' => __('ログイン'), 'class' => 'btn btn-primary')); ?>
