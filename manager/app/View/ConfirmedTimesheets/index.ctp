...
<div class="calendar-container">
    ...
    while ($currentDay->format('Y-m-d') <= $lastDayOfMonth) {
        ...
        echo '<td class="' . $class . '"><a href="' . $this->Html->url(array('controller' => 'confirmedTimesheets', 'action' => 'edit', $currentDay->format('Y'), $currentDay->format('m'), $currentDay->format('d'))) . '">' . $currentDay->format('j') . '</a></td>';
